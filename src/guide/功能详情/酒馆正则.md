...
[点击查看对应类型定义文件（可发给AI或IDE使用，酒馆助手设置中提供了打包下载）](https://github.com/N0VI028/JS-Slash-Runner/blob/main/%40types/function/tavern_regex.d.ts)
...
```typescript [formatAsTavernRegexedString]
...
```typescript [FormatAsTavernRegexedStringOption]
