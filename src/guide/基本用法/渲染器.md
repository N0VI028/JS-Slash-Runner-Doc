...
渲染深度决定了渲染器会渲染多少楼层的消息, 从最新楼层开始计数. 为 0 时, 将渲染所有楼层.
...
由于酒馆的代码高亮机制会消耗大量性能, 造成卡顿, 取消前端代码高亮可以提升聊天加载速度. 此处只取消会渲染成界面的代码块的高亮, 不影响纯文字状态栏等普通代码块的高亮.
...
Vue、React 等现代框架; 此外, 酒馆助手为其额外提供了 "功能详情" 中的各种功能, 如修改世界书、修改预设、设置变量、注入提示词等. 最初灵感来自阡濯的 [html 代码注入器](https://discord.com/channels/1134557553011998840/1271783456690409554).
